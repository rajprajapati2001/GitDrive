      ...
      <div className="bg-white rounded-2xl w-full max-w-md shadow-xl border border-slate-100 overflow-hidden">
        <div className="p-6 border-b border-slate-100 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-orange-800 text-lg">GitHub Drive Storage</h3>
          ...
          <div className="pt-4 border-t border-slate-100 flex items-center justify-between gap-3">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className={`px-4 py-2 text-sm font-semibold text-white bg-orange-600 hover:bg-orange-700 disabled:bg-orange-300 rounded-xl flex items-center gap-1.5 shadow-sm shadow-blue-600/10 transition-colors cursor-pointer`}
              >
                {testStatus === "testing" ? (
                  <>
