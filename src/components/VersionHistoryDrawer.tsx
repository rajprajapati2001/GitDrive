    ...
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="relative w-full max-w-md bg-white h-full shadow-2xl flex flex-col z-10 border-l border-slate-100 animate-slide-in">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          <div className="p-3.5 bg-orange-50/60 border border-orange-100 rounded-xl">
            <div className="flex gap-2 text-orange-800 text-xs leading-relaxed">
                  ...
                  <div key={commit.sha} className="relative group">
                    ...
                    <span
                      className={`absolute -left-[30px] top-1 w-4 h-4 rounded-full border-2 bg-white flex items-center justify-center ${
                        isCurrent ? "border-orange-500 ring-4 ring-orange-50" : "border-slate-300"
                      }`}
                    >
                      {isCurrent && <span className="w-1.5 h-1.5 rounded-full bg-orange-500"></span>}
                    </span>
                      ...
                      <div className="flex items-center gap-2 pt-2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
                        ...
                        {!isCurrent && (
                          <button
                            ...
                            className="px-2.5 py-1 text-xs font-semibold text-orange-600 hover:text-orange-800 bg-orange-50 hover:bg-orange-100 disabled:bg-slate-50 disabled:text-slate-400 rounded-lg flex items-center gap-1 transition-colors cursor-pointer"
                          >
