...
export default function Sidebar({
  ...
  return (
    <aside className="w-64 bg-gradient-to-b from-slate-50 to-[#a42100] border-r border-orange-400/30 shadow-[4px_0_24px_rgba(0,0,0,0.05)] shrink-0 h-full flex flex-col p-4 select-none text-white">
      {/* Logo Header in Sidebar */}
      <div className="flex items-center gap-2 mb-6 px-1">
        <img src={GitDrive} alt="GitDrive Logo" width={24} height={24} />
      ...
      <div className="mt-5 pt-4 border-t border-white/20">
        ...
        <div className="w-full bg-orange-900/30 h-2 rounded-full overflow-hidden flex border border-black/10 shadow-inner">
          <div
            className={`h-full transition-all duration-500 rounded-full ${
              progressPercent > 80 ? "bg-red-400" : progressPercent > 50 ? "bg-amber-400" : "bg-orange-300 drop-shadow-[0_0_2px_rgba(147,197,253,0.5)]"
            }`}
