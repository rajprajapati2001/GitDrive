          ...
          {!isImage && !isVideo && !isAudio && !isText && (
            <div className="text-center space-y-4 max-w-xs">
              ...
              <button
                ...
                className="mx-auto px-4 py-2 bg-orange-50 hover:bg-orange-100 text-orange-600 font-semibold text-xs rounded-xl flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
              >
        ...
        <div className="w-full md:w-80 p-6 flex flex-col justify-between overflow-y-visible md:max-h-none md:overflow-y-auto">
          ...
          <div className="mt-8 space-y-2 pt-4 border-t border-slate-100">
            ...
            <div className="grid grid-cols-2 gap-2 pt-2">
              <button
                onClick={handleDownload}
                className="w-full py-2 bg-orange-600 hover:bg-orange-700 text-white font-semibold text-xs rounded-xl flex items-center justify-center gap-1.5 shadow-sm shadow-orange-600/10 transition-colors cursor-pointer"
              >
