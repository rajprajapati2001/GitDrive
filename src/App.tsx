  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-slate-50 font-sans">
      ...
      <header className="h-14 bg-white border-b border-slate-200 flex items-center justify-between px-4 shrink-0 select-none z-20">
        <div className="flex items-center gap-3 w-64">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg tracking-tight text-slate-800">GitDrive</span>
          </div>
        </div>
      ...
      <div className="flex-1 flex overflow-hidden relative">
        {/* Left Drawer on Small viewports */}
        <div
        ...
        />
        <div
          className={`absolute md:relative z-40 md:z-10 bg-white h-full shadow-2xl md:shadow-none transition-transform duration-300 ${
