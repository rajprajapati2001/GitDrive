...
import GitDrive from "../assets/gitdrive_64x64.png";
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        ...
        <header className="h-14 bg-white border-b border-slate-200 flex items-center justify-between px-4 shrink-0 select-none z-20">
          <div className="flex items-center gap-3 w-64 md:w-auto">
            ...
            <div className="flex items-center gap-2 md:hidden">
              <img src={GitDrive} alt="GitDrive Logo" width={20} height={20} className="rounded-sm" />
              <span className="font-bold text-xl tracking-tight bg-gradient-to-r from-[#a42100] to-[#ff5327] bg-clip-text text-transparent drop-shadow-sm">GitDrive</span>
            </div>
          </div>
          ...
          <div className="flex-1 max-w-2xl px-8 hidden sm:block">
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-100 border-none rounded-lg py-2 pl-10 pr-4 text-sm focus:ring-2 focus:ring-orange-500 text-slate-700 outline-none"
                value={searchQuery}
        ...
        <div className="flex-1 flex overflow-hidden relative">
          ...
          >
            ...
            {isDragging && (
              <div className="absolute inset-0 bg-orange-600/10 backdrop-blur-xs ring-4 ring-orange-500/30 font-medium text-orange-600 border-4 border-dashed border-orange-500 rounded-2xl m-6 z-50 flex flex-col items-center justify-center gap-3 animate-fade-in pointer-events-none">
                <Plus className="w-12 h-12 text-orange-600 animate-bounce" />
                  ...
                  return (
                    <React.Fragment key={index}>
                      ...
                      <button
                        ...
                        className={`text-sm tracking-tight font-semibold hover:text-orange-600 transition-colors ${
                      ...
                      return (
                        ...
                        >
                          <td className="px-4 py-2 flex items-center gap-3">
                            ...
                            <span className="font-semibold text-sm text-slate-800 hover:text-orange-600 transition-colors truncate max-w-[130px] sm:max-w-xs md:max-w-md">
                              {file.name}
                            </span>
                          </td>
                          <td className="px-4 py-2 text-center">
                            {!isDir ? (
                              <button
                                ...
                                className="p-1.5 hover:bg-orange-50 text-orange-500 hover:text-orange-600 rounded-lg transition-colors inline-flex items-center justify-center cursor-pointer"
                              >
          ...
          <div className="bg-white rounded-2xl w-full max-w-sm shadow-xl border border-slate-100 overflow-hidden">
            ...
            <form onSubmit={handleCreateFolder} className="p-5 space-y-4">
              <input
                ...
                required
                className="w-full px-3.5 py-2 text-sm bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all font-medium text-slate-700"
                value={newFolderName}
              ...
              <div className="flex justify-end gap-2 text-xs">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 bg-orange-600 hover:bg-orange-700 font-bold text-white rounded-lg transition-colors cursor-pointer"
                >
                  Create
                </button>
              </div>
